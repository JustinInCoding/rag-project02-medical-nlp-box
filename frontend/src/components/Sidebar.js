  ...
  return (
    <div className="bg-white shadow-lg" style={{ width: `${width}px` }}>
      <div className="p-5">
        ...
        <h1 className="text-xl font-bold mb-2">金融术语处理工具箱</h1>
        <p className="text-sm text-gray-600 mb-4">强大的金融术语记录处理工具集</p>
      </div>
      <nav className="mt-5">
